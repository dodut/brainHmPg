...
<title>(주)브레인컨설팅 시너지유통사업팀</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 시너지유통사업팀" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 시너지유통사업팀" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub2_6" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 시너지유통사업팀"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub2_6"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 시너지유통사업팀">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 시너지유통사업팀";
	</script>
				<script>
			// AI-LOG 기본 스크립트
			...
			var ai_log_page_title = "(주)브레인컨설팅 시너지유통사업팀"; // 페이지 제목
			var ai_log_page_url = "/page/sub2_6"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div class="sub2_1">
  <p>“도난방지시스템(AM안테나,RF안테나,라벨소거기해제기,하드텍 라벨)  피플카운팅”</p>
  <section>
    <h4>도난방지시스템</h4>
    <p>
      상품보안과 도난방지의 첫걸음,  효율적이고 안전한 운영을 위해 필수적인 도난방지 안테나를 만나보세요. 
    </p>
     <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_6_1.jpg">
    </p>
  </section>
  <section class="organize">
    <h4>라벨 감성 제거기/하드텍 분리기/소모품</h4>
    <p>다양하고 제품군에 감지율 높고 내구성 강한 소모품을 사용 하세요.</p>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_6_2.jpg">
    </p>
  </section>
 ...
 <section class="organize">
    <h4>설치사례</h4>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_6_3.jpg">
    </p>
  </section>
  
  <section class="organize">
    <h4>피플카운팅</h4>
    <p>인원 카운팅부터 데이터분석까지 매장운영의 객관적인 지표가 됩니다.</p>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_6_4.jpg">
    </p>
  </section>
  
  <section class="organize" style="border-bottom: 0 !important;">
    <h4>TD2000 레포트  대시보드 , 엑셀전환 </h4>
    <p>대시보드 – 일간, 주간, 월간 리포트 및  엑셀파일 전환 </p>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_6_5.jpg">
    </p>
  </section>
</div>    </div>
       </div>
