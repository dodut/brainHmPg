...
<title>(주)브레인컨설팅 조직도</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 조직도" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 조직도" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub1_3" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 조직도"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub1_3"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 조직도">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 조직도";
			...
			var ai_log_page_title = "(주)브레인컨설팅 조직도"; // 페이지 제목
...
<div id="sub">
		...
		#pm2-snb h3 {height:80px; line-height:80px; background:#1479c0; color:#fff; font-size:20px; text-align:center;}
			...
			<div id="pm2-snb">
			  <h3>회사소개</h3>
				<ul class="dep2">
					<li>
						<a href="/page/sub1_1">CEO인사말</a>
					</li>					
					<li>
						<a href="/myboard/sub1_2">연혁&실적</a>
					</li>					
					<li class="on">
						<a href="/page/sub1_3">조직도</a>
					</li>					
					<li>
						<a href="/page/sub1_4">찾아오시는 길</a>
					</li>			
				</ul>
			</div>    
		</div> <!-- .snb end -->
	...
	<!--  <div class="ceo">
	  ...
	  <div class="section">
	    <ul>
	      ...
	      <lI class="head system"><p>시스템사업본부</p>
	        <ul>
	          <li class="team">
	            <b>시스템사업부</b>
	            <span>ESL 영업</span>
	          ...
	          <li class="team elec">
	            <b>전자경매사업부</b>
	            <span>전자경매시스템 영업</span>
	            <span>전자경매시스템 지원</span>
	            <div class="place">
	              <b>전자경매지사</b>
	              <span>호남 지사</span>
	              <span>경남 지사</span>
	...
	<p class="img">
		<img src="/img_up/shop_pds/brin/design/img/sub1_3img.jpg">
	<!-- 	<img class="sub1_3pc" src="/img_up/shop_pds/brin/design/img/jo-jik-do_01.jpg"> -->
	<!-- 	<img class="sub1_3m" src="/img_up/shop_pds/brin/design/img/jo-jik-do_02.jpg"> -->
	</p>
