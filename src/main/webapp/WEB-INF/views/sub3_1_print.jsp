...
<script>
	...
	var ai_log_page_title = "​​​​${dto.title}"; // 페이지 제목
	var ai_log_page_url = "/bbs/sub3_1/${dto.seq}"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div id="scbd" class="scbd co-basic-simple">
	...
	<div class="det">
		...
		<div class="snsShare">
			...
			<a href="javascript:scrap_facebook_pop(7975)" class="ui-ico facebook">Facebook</a>						
...
function readArticle(idx){
	location.href="/bbs_shop/read.htm?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=&y=&m=&idx="+idx;
}
function reply_readArticle(idx){
	location.href="/bbs_shop/read.htm?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=&idx="+idx;
}
...
function secret_read2(idx){
	var secret_read2_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_secret&me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=&idx='+idx,'secret_read2_win','top=150,left=300,width=330,height=200,scrollbars=no');
...
function goList(){
	location.href="/bbs_shop/list.htm?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&keyfield=&key=&page=&y=&m=";
}
function editArticle(){
						var edit_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_edit&me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&keyfield=&key=&page=&idx=7975','edit_win','top=150,left=300,width=330,height=450,scrollbars=no');
			edit_win.focus();
...
function deleteArticle(){
						var del_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_del&me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=','del_win','top=150,left=300,width=330,height=450,scrollbars=no');
			del_win.focus();
			}
function moveArticle(){
			var move_win = window.open('/bbs_shop/popup/move_form.htm?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=','move_win','top=150,left=300,width=330,height=450,scrollbars=no');
		move_win.focus();
	}

function secret_read(idx){
			var move_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_secret&me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&keyfield=&key=&page=&idx='+idx,'move_win','top=150,left=300,width=330,height=450,scrollbars=no');
		move_win.focus();
	}
...
function goConfirm(){
	if(confirm("정상등록 하시겠습니까?")){
		...
		document.getElementById(iframe_name).src="/bbs_shop/confirm_ok.php?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=";
	}
}
...
function goConfirm_no(){
	if(confirm("게시글을 안보이도록 설정 하시겠습니까?")){
		var iframe_name = create_iframe();
		document.getElementById(iframe_name).src="/bbs_shop/confirm_no.php?me_popup=3&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=";
	}
}
...
function board_view_print(){
		...
		var window_left = (screen.width-w)/2;
		var window_top = (screen.height-h)/2;
		var board_view_print_win = window.open('/bbs_shop/read.htm?print_yn=1&board_code=sub3_1&idx=7975','board_view_print_win','top='+window_top+',left='+window_left+',width='+w+',height='+h+',toolbar=no,scrollbars=yes,resizable=yes,status=yes,menubar=no,location=no');
