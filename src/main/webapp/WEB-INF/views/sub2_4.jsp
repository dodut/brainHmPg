...
<title>(주)브레인컨설팅 SI사업본부</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 SI사업본부" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 SI사업본부" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub2_4" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 SI사업본부"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub2_4"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 SI사업본부">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 SI사업본부";
	</script>
				<script>
			// AI-LOG 기본 스크립트
			...
			var ai_log_page_title = "(주)브레인컨설팅 SI사업본부"; // 페이지 제목
...
<div id="pm2-snb">
 ...
 <!--<section>
    <h4>사업소개</h4>
    <p>
      (주)브레인 컨설팅은 농축산 정보화 시장에서 <b>30여년간 넘게 쌓아온 성숙된 경험과 노하우</b>를 바탕으로 비즈니스에 대한 깊은 지식과 검증된 역량, 시스템 통합에 대한 우수한 통찰력을 제공함으로써 고객의 경쟁력을 한 단계 업그레이드하고 <b>최상의 고객 가치를 창출</b>할 수 있도록 <b>맞춤형 End-To-End 서비스</b>를 지향 합니다.
    </p>
    <p>
      (주)브레인 컨설팅은 농축산 유통정보화의 <b class="green">ISP.BPR, 시스템 통합 및 운영, IT 아웃 소싱</b> 등 고객이 원하는 BPI 에서 부터 시스템 구축.운영을 아우르는 <b class="green">One-Stop 서비스를 제공</b>합니다.
    </p>
   <br>
    <p><img src="/img_up/shop_pds/brin/design/img/sub2_401.jpg"></p>
  </section>
  <section class="isp">
    <h4>ISP.BPR</h4>
    <p>
      (주)브레인 컨설팅은 농축산 정보화 시스템에 <b>특화된 프레임워크와 방법론을 통해 비즈니스 프로세스를 혁신</b>하고 <b class="green">발빠른 IT 전략과 로드맵</b>을 제공합니다. 당사가 보유한 선진사 정보화에 대한 벤치마킹 기법과 정보화 투자 평가 방법론을 적용하여 최저 비용 대비 최대 효과를 창출할 수 있는 시스템 구축 방안을 제시합니다.
    </p>
    <br>
    <p><img src="/img_up/shop_pds/brin/design/img/sub2_402.jpg"></p>
    <br><br>
    <p><img src="/img_up/shop_pds/brin/design/img/sub2_403.jpg"></p>
  </section>-->
  <!--before 200428-->
  <section>
    <h4>사업소개</h4>
    <p> 농협경제 업무 및 유통 축산 업무에 특화된 높은 기술력과 오랜 개발 경험을 보유한 브레인컨설팅은 최적의 역량을 투입하여 최상의 사용성과 성능을 보유한 시스템을 개발하여 고객사 서비스의 성공적인 런칭과 활성화에 공헌합니다. </p>
    <p class="img"><img src="/img_up/shop_pds/brin/design/img/sub2_4img.jpg"></p>
    <ul>
      <li><div>
        <h4>성능 최적화 및 신기술</h4>
        <dl>
          <dd>· PC기반 Solution, WebService 및 Moblie Hybride App 호환제작</dd>
          <dd>· 고객이 원하는 기술로 맞춤 구현</dd>
        </dl>
        </div></li>
      <li><div>
        <h4>사용 편의성 및 확장성</h4>
        <dl>
          <dd>· PC최적화 업무 시스템 개발 경력으로 UI설계 노하우</dd>
          <dd>· PC 기반 업무의 모바일 연동 경험 및 기술</dd>
        </dl>
        </div></li>
      <li><div>
        <h4>개발기간 및 비용 최적화</h4>
        <dl>
          <dd>· 적극적인 소통으로 사용자의 니즈를 파악</dd>
          <dd>· 고객이 원하는 스펙에 맞는 최적화된 비용 견적화</dd>
          <dd>· 유사 업무 지원 인력 POOL 보유</dd>
        </dl>
        </div></li>
      <li><div>
        <h4>안정적 시스템운영 SM 연계</h4>
        <dl>
          <dd>· 시스템 통합 개발 후 시스템 운영 및 관리까지 위탁 가능함으로써 추가 개발 및 수정건에 대한 유기적 연계 가능</dd>
        </dl>
        </div></li>
    </ul>
  </section>
  <section>
    <h4>주요고객사</h4>
    <ul>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh1.jpg" alt="농협정보시스템"></li>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh2.jpg" alt="농협유통"></li>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh3.jpg" alt="농협경제지주"></li>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh4.jpg" alt="농협중앙회"></li>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh5.jpg" alt="NH농협"></li>
      <li><img src="/img_up/shop_pds/brin/design/img/sub2_4nh6.jpg" alt="농협은행"></li>
    </ul>
  </section>
</div>    </div>
       </div>
