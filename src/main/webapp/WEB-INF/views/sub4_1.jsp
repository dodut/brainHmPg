...
<title>(주)브레인컨설팅 채용절차</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 채용절차" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 채용절차" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub4_1" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 채용절차"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub4_1"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 채용절차">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 채용절차";
			...
			var ai_log_page_title = "(주)브레인컨설팅 채용절차"; // 페이지 제목
			var ai_log_page_url = "/page/sub4_1"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div id="pm2-snb">
 ...
 <section>
    <p class="img">
      <img src="/img_up/shop_pds/brin/design/img/sub4_1img.jpg" alt="채용절차">
   </p>
  </section>
  <section>
    <ul>
      <li><h4><b>①</b> 서류</h4><p>기본 입력사항, 자기소개서, 부문별 자격요건, 인원계획 등을 감안하여 면접 전형 대상자를 선정합니다.</p></li>
      <li><h4><b>②</b> 실무면접</h4><p>실제 업무를 수행하기 위한 능력과 업무 수행 능력을 위주로 평가합니다.</p></li>
      <li><h4><b>③</b> 최종합격</h4><p>모든 전형을 통과한 지원자에게 최종합격을 통보합니다.</p></li>
    </ul>
  </section>
</div>    </div>
       </div>
