...
<div class="wrap" id="wrap">
	<div class="attachFile container">
		...
		<form name="formName" method="post" action="/bbs/fileUploadProc">
...
<div class="wrap" id="wrap">
	<div class="attachFile container">
		...
		<form name="formName" method="post" enctype="multipart/form-data" action="/bbs/fileUploadProc">
		<input type="hidden" name="tmp_name" value="tmp_val"/>
		<input type="hidden" name="mode" value="file"/>
		<input type="hidden" name="board_code"/>
		<input type="hidden" name="use_size"/>
			...
			<fieldset>
				<legend class="blind">File attach form</legend>
				<input type="file" id="add_file" name="add_file" style="max-width: 200px" /> 
				<label for="add_file" class="label_none">파일첨부 test</label>
