...
<meta name="subject" content="​​22년 01월 용암농협 스마트III-DOUBLE 적용" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="​​22년 01월 용암농협 스마트III-DOUBLE 적용" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<meta name="description" content="​22년 01월 용암농협 스마트III-DOUBLE 적용 완료하였습니다." />
<link rel="canonical" href="http://www.brain21c.co.kr/bbs/sub3_1/7975" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="​​22년 01월 용암농협 스마트III-DOUBLE 적용"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/bbs/sub3_1/7975"/>
<meta property="og:description"     content="​22년 01월 용암농협 스마트III-DOUBLE 적용 완료하였습니다."/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="​​22년 01월 용암농협 스마트III-DOUBLE 적용">
<meta name="twitter:site"           content="(주)브레인컨설팅">
<meta name="twitter:creator"        content="(주)브레인컨설팅">
<meta name="twitter:description"    content="​22년 01월 용암농협 스마트III-DOUBLE 적용 완료하였습니다.">
...
<!--[if lt IE 9]>
	...
	<script type="text/javascript">
		...
		var page_title = "​​22년 01월 용암농협 스마트III-DOUBLE 적용";
	</script>
	<script>
		// AI-LOG 기본 스크립트
		...
		var ai_log_page_title = "​​22년 01월 용암농협 스마트III-DOUBLE 적용"; // 페이지 제목
		var ai_log_page_url = "/bbs/sub3_1/7975"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
		...
		<div class="cont">
			...
			<div id="scbd" class="scbd co-basic-simple">
				...
				<div id="lay_hd" class="lay_hd">
					<div class="hgroup">
						<h1><a href="javascript:goList()">공지사항</a></h1>
						<ul>
							<li>
				...
				<div class="det">
					...
					<!-- url copy -->
					<div class="copyurl">
						<a href="/bbs/sub3_1_view?seq=${dto.seq}" target="_blank">http://www.brain21c.co.kr/bbs/sub3_1_view?seq=${dto.seq}</a>
						<a href="javascript:clip('/bbs/sub3_1_view?seq=${dto.seq}')" class="btn" title="URL COPY">URL COPY</a>
					</div>
					<!-- // url copy -->
					...
					<div class="snsShare">
						...
						<a href="javascript:scrap_twitter_pop(7975)" class="ui-ico twitter">Twitter</a>			
						<a href="javascript:scrap_facebook_pop(${dto.seq})" class="ui-ico facebook">Facebook</a>						
						<a href="javascript:scrap_cyworld_pop(7975)" class="ui-ico cyworld">Cyworld</a>			
						<a href="javascript:scrap_mypage_pop(7975)" class="ui-ico mypage">Mypage</a>		
					</div>		
					<!-- // SNS share -->
...
function readArticle(idx){
	location.href="/bbs_shop/read.htm?me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=0&y=&m=&idx="+idx;
}
function reply_readArticle(idx){
	location.href="/bbs_shop/read.htm?me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=0&idx="+idx;
}
...
function secret_read2(idx){
			var secret_read2_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_secret&me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&search_key=&key=&page=0&idx='+idx,'secret_read2_win','top=150,left=300,width=330,height=200,scrollbars=no');
...
function goList(){ 
	location.href="/bbs/sub3_1?page="+currentPageNo+"&board_code=sub3_1&search_key="+search_key;
}
function editArticle(){
	var edit_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_edit&me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&keyfield=&key=&page=0&idx=7975','edit_win','top=150,left=300,width=330,height=450,scrollbars=no');
	edit_win.focus();
}
function replyArticle(){
	alert("본 게시판은 로그인을 해야만 답변글을 쓸 수 있습니다.");
}
function deleteArticle(){
	var del_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_del&me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=0','del_win','top=150,left=300,width=330,height=450,scrollbars=no');
	del_win.focus();
}
function moveArticle(){
	var move_win = window.open('/bbs_shop/popup/move_form.htm?me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=0','move_win','top=150,left=300,width=330,height=450,scrollbars=no');
	move_win.focus();
}

function secret_read(idx){
	var move_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_secret&me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&board_code=sub3_1&keyfield=&key=&page=0&idx='+idx,'move_win','top=150,left=300,width=330,height=450,scrollbars=no');
	move_win.focus();
}
...
function goConfirm(){
	if(confirm("정상등록 하시겠습니까?")){
		...
		document.getElementById(iframe_name).src="/bbs_shop/confirm_ok.php?me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=0";
	}
}
...
function goConfirm_no(){
	if(confirm("게시글을 안보이도록 설정 하시겠습니까?")){
		var iframe_name = create_iframe();
		document.getElementById(iframe_name).src="/bbs_shop/confirm_no.php?me_popup=&auto_frame=&cate_sub_idx=0&search_first_subject=&list_mode=board&idx=7975&board_code=sub3_1&keyfield=&key=&page=0";
	}
}
...
function board_view_print(){
	...
	var seq = '${dto.seq}';
	var board_view_print_win = window.open('/bbs/sub3_1_print?print_yn=1&board_code=sub3_1&seq='+seq,'board_view_print_win','top='+window_top+',left='+window_left+',width='+w+',height='+h+',toolbar=no,scrollbars=yes,resizable=yes,status=yes,menubar=no,location=no');
...
function file_download(sel_no,file_name){
	...
	var iframe_name = create_iframe();
	document.getElementById(iframe_name).src = "/bbs_shop/file_download.php?board_code=sub3_1&board_idx=7975&sel_no="+sel_no;
}
...
function vicious_chk(){
	...
	var window_left = (screen.width-w)/2;
	var window_top = (screen.height-h)/2;
	var vicious_chk_win = window.open('/bbs_shop/popup/vicious_form.htm?mode=board&idx=7975','vicious_chk','top='+window_top+',left='+window_left+',width='+w+',height='+h+',toolbar=no,scrollbars=yes,resizable=yes,status=yes,menubar=no,location=no');
...
function board_chu_ok(){
	if(confirm("추천 하시겠습니까?")){
		var iframe_name = create_iframe();
		document.getElementById(iframe_name).src="/bbs_shop/read_chu_ok.php?board_code=sub3_1&idx=7975";
	}
}
...
function board_oppose_ok(){
	if(confirm("반대 하시겠습니까?")){
		var iframe_name = create_iframe();
		document.getElementById(iframe_name).src="/bbs_shop/read_oppose_ok.php?board_code=sub3_1&idx=7975";
	}
}

function view_Poll(){
	location.href="/bbs_shop/read.htm?board_code=sub3_1&idx=7975&poll_view=1";
}
...
function vote_Poll(){
	...
	if(!poll_sel){
		...
		location.replace("/bbs_shop/read.htm?board_code=sub3_1&idx=7975&poll_idx=0&poll_sel="+poll_sel)
	}
}
