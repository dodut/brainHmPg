...
<title>(주)브레인컨설팅 복리후생</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 복리후생" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 복리후생" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub4_2" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 복리후생"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub4_2"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 복리후생">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 복리후생";
			...
			var ai_log_page_title = "(주)브레인컨설팅 복리후생"; // 페이지 제목
			var ai_log_page_url = "/page/sub4_2"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div id="pm2-snb">
  <h3>인재채용</h3>
    ...
    <section>
        <ul>
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico1.jpg"></div>
                <div class="txt">
                    <h3 class="tit">4대보험 및 퇴직연금 가입</h3>
                    <p>국민연금, 건강보험, 고용보험, 산재보험 필수 4대 보험 및 퇴직연금 가입장입니다. </p>
                </div>
            </li>
            <!--1-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_1ic1.jpg"></div>
                <div class="txt">
                    <h3 class="tit">건강검진 지원</h3>
                    <p>전문 의료 기관과 연계하여 건강검진을 실시함으로써 임직원의 건강과 활기찬 생활에 도움을 드립니다.(매년 일반건강검진 및 특별건강검진 실시)</p>
                </div>
            </li>
            <!--2-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico3.jpg"></div>
                <div class="txt">
                    <h3 class="tit">우수사원 표창</h3>
                    <p>매년 브레인컨설팅의 정신에 맞는 사원을 선정하여 상을 수여하고 있습니다.</p>
                </div>
            </li>
            <!--3-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico4.jpg"></div>
                <div class="txt">
                    <h3 class="tit">자기 개발 교육비 지원</h3>
                    <p>사내규칙에 따라 업무에 필요한 과정의 연수/교육비를 지원 하고 있습니다.</p>
                </div>
            </li>
            <!--4-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico5.jpg"></div>
                <div class="txt">
                    <h3 class="tit">문화활동비 지원</h3>
                    <p>직원들의 복지를 위해 매달 문화활동 지원비가 지급됩니다.</p>
                </div>
            </li>
            <!--5-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico6.jpg"></div>
                <div class="txt">
                    <h3 class="tit">상조회 운영</h3>
                    <p>임직원의 고락을 함께하는 상조회를 운영하고 있습니다.</p>
                </div>
            </li>
            <!--6-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico7.jpg"></div>
                <div class="txt">
                    <h3 class="tit">자녀 입학 축하금</h3>
                    <p>초, 중, 고, 대학교 입학 축하금을 지원하고 있습니다.</p>
                </div>
            </li>
            <!--7-->
            <li>
                <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico8.jpg"></div>
                <div class="txt">
                    <h3 class="tit">커피머신</h3>
                    <p>아침을 깨우는 신선한 원두와 에스프레소 머신을 구비하고 있습니다.</p>
                </div>
            </li>
            <!--8-->
...
<!--<div class="sub4_2">
 <section>
    <ul>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico1.jpg"></div>
        <div class="txt"><h3 class="tit">4대보험</h3><p>국민연금, 건강보험, 고용보험, 산재보험 필수 4대 보험 가입장입니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico2.jpg"></div>
        <div class="txt"><h3 class="tit">퇴직연금 가입</h3><p>퇴직연금 가입으로 임직원의 정년 이후 삶까지 함께 생각합니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico3.jpg"></div>
        <div class="txt"><h3 class="tit">우수사원 표창</h3><p>매년 브레인컨설팅의 정신에 맞는 사원을 선정하여 상을 수여하고 있습니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico4.jpg"></div>
        <div class="txt"><h3 class="tit">자기 개발 교육비 지원</h3><p>사내규칙에 따라 업무에 필요한 과정의 연수/교육비를 지원 하고 있습니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico5.jpg"></div>
        <div class="txt"><h3 class="tit">문화활동비 지원</h3><p>직원들의 복지를 위해 매달 문화활동 지원비가 지급됩니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico6.jpg"></div>
        <div class="txt"><h3 class="tit">상조회 운영</h3><p>임직원의 고락을 함께하는 상조회를 운영하고 있습니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico7.jpg"></div>
        <div class="txt"><h3 class="tit">자녀 입학 축하금</h3><p>초, 중, 고, 대학교 입학 축하금을 지원하고 있습니다.</p></div>
      </li>
      <li>
        <div class="img"><img src="/img_up/shop_pds/brin/design/img/sub4_2ico8.jpg"></div>
        <div class="txt"><h3 class="tit">커피머신</h3><p>아침을 깨우는 신선한 원두와 에스프레소 머신을 구비하고 있습니다.</p></div>
      </li>
   </ul>
  </section>
</div>-->    </div>
