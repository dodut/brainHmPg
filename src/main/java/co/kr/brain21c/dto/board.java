...
public class board {
	...
	public String toString() {
		return "board [num=" + num + ", subDate=" + subDate + ", gnb=" + gnb + ", seq=" + seq + ", grpno=" + grpno
				+ ", grpord=" + grpord + ", title=" + title + ", cntn=" + cntn + ", hits=" + hits + ", rgdtm=" + rgdtm
				+ ", rgwriter=" + rgwriter + ", eddtm=" + eddtm + ", edwriter=" + edwriter + ", bdpw=" + bdpw + "]";
	}
