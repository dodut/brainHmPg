...
<title>(주)브레인컨설팅 전자경매</title>
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=yes">
<meta name="subject" content="(주)브레인컨설팅 전자경매" />
<meta name="copyright" content="(주)브레인컨설팅" />
<meta name="title" content="(주)브레인컨설팅 전자경매" />
<meta name="apple-mobile-web-app-title" content="(주)브레인컨설팅" />
<meta name="application-name" content="(주)브레인컨설팅" />
<meta name="theme-color" content="#ffffff" />
<link rel="canonical" href="http://www.brain21c.co.kr/page/sub2_1" />
<meta property="og:type"            content="website"/>
<meta property="og:title"           content="(주)브레인컨설팅 전자경매"/>
<meta property="og:site_name"       content="(주)브레인컨설팅"/>
<meta property="og:url"             content="http://www.brain21c.co.kr/page/sub2_1"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)브레인컨설팅 전자경매">
...
<link rel="stylesheet" type="text/css" href="/img_up/shop_pds/brin/src_css/base_m.css" media="only all and (max-width:1000px)"/>
	...
	var page_title = "(주)브레인컨설팅 전자경매";
			...
			var ai_log_page_title = "(주)브레인컨설팅 전자경매"; // 페이지 제목
  ...
  <h3>사업부문</h3>
    ...
    <div class="cont">
      ...
      <p class="navi">
        홈 &gt; 사업부문 &gt; 전자경매사업부      </p>
      <div class="sub2_1">
  <p>“대한민국 NO.1 농&amp;축산물 전자경매 대표기업”</p>
  <section>
    <h4>전자경매란??</h4>
    <p>
      기존의 수지경매 방식과 동일한 흐름을 유지하면서 수신호가 아닌 무선단말기를 이용하여 출하된 물건에 대한 금액을 제시하여 최고금액을 제시한 중도매인에게 물건이 낙찰되는 방식으로 업무처리 하는 시스템을 말합니다. 경매업무의 투명성 확보를 위해 대형 멀티전광판 및 이동식전광판을 통해 실시간으로 낙찰되는 현황을 현장에서 보여줌으로써 소비자들도 믿고 구입할 수 있는 최고의 시스템입니다. 약 20년 이상 축척 된 기술력을 바탕으로 농협 경제지주 직영공판장 12곳을 비롯한 각농협 농산물경매장과 각축협에서 운영하는 가축경매시장을 모두 합쳐 총 180여곳의 경매시설에 성공적으로 시스템을 설치하여 적용하였습니다. 또한 경매업무에 필요한 각종 특허권 출원 및 정보통신 기기 인증, 각종 프로그램 등록 등 최고의 기술력을 바탕으로 안정적인 업무를 처리하고 있습니다.
    </p>
    <p>
      (주)브레인컨설팅은 국내 최고의 전자경매 기업으로 만족하지 않고 세계 최고의 전자경매 리더기업으로 거듭 나겠습니다.
    </p>
    <div class="img">
      <p>
        <img src="/img_up/shop_pds/brin/design/img/sub2_106_re.jpg">
        <span>무선응찰기(SMART3)</span>
      </p>
      <p>
        <img src="/img_up/shop_pds/brin/design/img/sub2_107.jpg">
        <span>수신제어기(SMART-III)</span>
      </p>
      <p>
        <img src="/img_up/shop_pds/brin/design/img/sub2_101.jpg">
        <span>무선응찰기(SMART2)</span><span  class="sold_out"> (단종)</span>
      </p>
      <p>
        <img src="/img_up/shop_pds/brin/design/img/sub2_102.jpg">
        <span>수신제어기(SMART-II)</span><span  class="sold_out"> (단종)</span>
      </p>
    </div>
  </section>
  <section class="organize">
    <h4>농산물 전자경매시스템 구성도</h4>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_103_re.jpg">
    </p>
  </section>
  <section class="organize">
    <h4>가축시장 전자경매시스템(단일경매)</h4>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_104_re.jpg">
    </p>
  </section>
  <section class="organize">
    <h4>가축시장 전자경매시스템(일괄경매)</h4>
    <p>
      <img src="/img_up/shop_pds/brin/design/img/sub2_105_re.jpg">
    </p>
  </section>
</div>    </div>
       </div>
